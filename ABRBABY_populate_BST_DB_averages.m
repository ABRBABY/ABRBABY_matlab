...
% sFiles = bst_process('CallProcess', 'process_diff_ab', sFiles(contains({sFiles.FileName}, 'DEV1')), sFiles(contains({sFiles.FileName}, 'STD1')));
...
% sFiles = bst_process('CallProcess', 'process_diff_ab', sFiles(contains({sFiles.FileName}, 'DEV2')), sFiles(contains({sFiles.FileName}, 'STD2')));
