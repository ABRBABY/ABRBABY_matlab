function [EEG] = detect_events_and_create_report(EEG, indir, trig_modality, trig, report_option)
...
if strcmp(report_option,'report')
...
elseif strcmp(report_option,'no report')
    disp('Event detection done but no report file created.')
end
