...
%Description: MAXIMIZE the size of a window to fill the entire screen.
%Usage: maximize(h)
%	    resize figure h to fill the screen.
%Example: maximize(gfc) will maximize current figure.
%Author: Yuval Cohen, Be4 Ltd., yuval@gobe4.com
%
%
