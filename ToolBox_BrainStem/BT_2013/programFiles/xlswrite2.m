...
%   [SUCCESS,MESSAGE]=XLSWRITE2(FILE,ARRAY,SHEET,RANGE) writes ARRAY to the Excel
...
%   See NOTE 1.
%
%   [SUCCESS,MESSAGE]=XLSWRITE2(FILE,ARRAY) writes ARRAY to the Excel workbook,
%   FILE, starting at cell A1 of the first worksheet. The return values are as
%   for the above example.
%
%   XLSWRITE2 ARRAY FILE, is the command line version of the above example.
%
%   INPUT PARAMETERS:
...
%   $Revision: 1.1.6.6 $  $Date: 2004/12/27 23:33:10 $
%==============================================================================
% Set default values.
Sheet1 = 1;
...
try
    if ~exist(file,'file');
        ...
        % Open workbook.
        ExcelWorkbook = Excel.workbooks.Add(file);
    end
    try % select region.
    ...
    ExcelWorkbook.SaveCopyAs(file); % save as Excel Workbook;
...
%     warning('MATLAB:xlswrite:AddSheet','Added specified worksheet.');
     ...
     display(['MATLAB:xlswrite:AddSheet','Added  worksheet:', Sheet]);
