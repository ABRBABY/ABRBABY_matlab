function [StraightCorr CrossCorr Lag]=bt_qncorr2(Qfile, Nfile, start, stop, lagstart, lagstop, chanN, chan)
...
[junk  StraightCorr] = bt_xcorrelation2(Nfile, Qfile, start, stop, 0, 0, 'POSITIVE', chanN, chan);
[Lag  CrossCorr] = bt_xcorrelation2(Nfile, Qfile, start, stop, lagstart, lagstop, 'POSITIVE', chanN, chan);
