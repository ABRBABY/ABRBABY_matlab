...
OPTIONS.legend =    {sprintf('Std /DA/ control \n n= %d',nb_young),                                      sprintf('Std /DA/ 18-24m \n n= %d',nb_old)} ; 
...
OPTIONS.color =     {grpA_color,                                    grpB_color} ; 
OPTIONS.legend =    {sprintf('Dev /BA/ control \n %d',nb_young),     sprintf('Dev /BA/ 18-24m \n n= %d',nb_old)} ; 
...
OPTIONS.color =     {grpA_color,                                    grpB_color} ; 
OPTIONS.legend =    {sprintf('Dev /GA/ control \n %d',nb_young),     sprintf('Dev /GA/ 18-24m \n n= %d',nb_old)} ; 
...
OPTIONS.color =     {grpA_color,                                    grpB_color} ; 
OPTIONS.legend =    {sprintf('MMN /BA/ control \n %d',nb_young),     sprintf('MMN /BA/ 18-24m \n n= %d',nb_old)} ; 
...
OPTIONS.color =     {grpA_color,                                    grpB_color} ; 
OPTIONS.legend =    {sprintf('MMN /GA/ control \n %d',nb_young),     sprintf('MMN /GA/ 18-24m \n n= %d',nb_old)} ; 
...
%--------------------------------------------------------------------------
[fig] = display_one_group(grpA,1,OPTIONS,'control'); 

% Save figure in svg + png
print('-dsvg',fullfile(OPTIONS.svg_folder,strcat('control_display_STD_DEV_MMN_BA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.svg')));
print('-dpng',fullfile(OPTIONS.png_folder,strcat('control_display_STD_DEV_MMN_BA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.png')));
saveas(fig, fullfile(OPTIONS.fig_folder,strcat('control_display_STD_DEV_MMN_BA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.fig')));

%% Display : GroupA - DEV2 (/GA/)
%--------------------------------------------------------------------------
[fig] = display_one_group(grpA,2,OPTIONS,'control'); 

% Save figure in svg + png
print('-dsvg',fullfile(OPTIONS.svg_folder,strcat('control_display_STD_DEV_MMN_GA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.svg')));
print('-dpng',fullfile(OPTIONS.png_folder,strcat('control_display_STD_DEV_MMN_GA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.png')));
saveas(fig, fullfile(OPTIONS.fig_folder,strcat('control_display_STD_DEV_MMN_GA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.fig')));

%% Display : GroupA - mean(DEV1+DEV2) (/BA/ and /GA/)
%--------------------------------------------------------------------------
[fig] = display_one_group(grpA,3,OPTIONS,'control'); 

% Save figure in svg + png
print('-dsvg',fullfile(OPTIONS.svg_folder,strcat('control_display_STD_DEV_MMN_BA-GA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.svg')));
print('-dpng',fullfile(OPTIONS.png_folder,strcat('control_display_STD_DEV_MMN_BA-GA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.png')));
saveas(fig, fullfile(OPTIONS.fig_folder,strcat('control_display_STD_DEV_MMN_BA',OPTIONS.balance_STD,'_',OPTIONS.params,'.fig')));

%% Display : GroupB - DEV1 (/BA/)
%--------------------------------------------------------------------------
[fig] = display_one_group(grpB,1,OPTIONS,'cardiopath'); 

% Save figure in svg + png
print('-dsvg',fullfile(OPTIONS.svg_folder,strcat('cardiopath_display_STD_DEV_MMN_BA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.svg')));
print('-dpng',fullfile(OPTIONS.png_folder,strcat('cardiopath_display_STD_DEV_MMN_BA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.png')));
saveas(fig, fullfile(OPTIONS.fig_folder,strcat('cardiopath_display_STD_DEV_MMN_BA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.fig')));

%% Display : GroupB - DEV2 (/GA/)
%--------------------------------------------------------------------------
[fig] = display_one_group(grpB,2,OPTIONS,'cardiopath'); 

% Save figure in svg + png
print('-dsvg',fullfile(OPTIONS.svg_folder,strcat('cardiopath_display_STD_DEV_MMN_GA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.svg')));
print('-dpng',fullfile(OPTIONS.png_folder,strcat('cardiopath_display_STD_DEV_MMN_GA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.png')));
saveas(fig, fullfile(OPTIONS.fig_folder,strcat('cardiopath_display_STD_DEV_MMN_GA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.fig')));

%% Display : GroupB - mean(DEV1+DEV2) (/BA/ and /GA/)
%--------------------------------------------------------------------------
[fig] = display_one_group(grpB,3,OPTIONS,'cardiopath'); 

% Save figure in svg + png
print('-dsvg',fullfile(OPTIONS.svg_folder,strcat('cardiopath_display_STD_DEV_MMN_BA-GA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.svg')));
print('-dpng',fullfile(OPTIONS.png_folder,strcat('cardiopath_display_STD_DEV_MMN_BA-GA_',OPTIONS.balance_STD,'_',OPTIONS.params,'.png')));
saveas(fig, fullfile(OPTIONS.fig_folder,strcat('cardiopath_display_STD_DEV_MMN_BA',OPTIONS.balance_STD,'_',OPTIONS.params,'.fig')));
